...
module.exports = app => {
  ...
  // mongoose
  router.get('/users', controller.usermongoose.getusers)
  router.get('/addusers', controller.usermongoose.addusers)
  router.get('/edituser', controller.usermongoose.edituser)
  router.get('/deluser', controller.usermongoose.deluser)
}
